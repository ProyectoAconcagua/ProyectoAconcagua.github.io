...
BLOG_AUTHOR = "Aconcagua Team"  # (translatable)
BLOG_TITLE = "Proyecto Aconcagua"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://www.proyectoaconcagua.com.ar/"
SITE_URL_WITHOUT_SLASH = "http://www.proyectoaconcagua.com.ar"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.proyectoaconcagua.com.ar"
BLOG_EMAIL = "info@proyectoaconcagua.com.ar"
BLOG_DESCRIPTION = "Github page del Proyecto Aconcagua."  # (translatable)
...
LOGO_URL = '/assets/css/images/logo32.png'
...
GITHUB_SOURCE_BRANCH = 'nikola_src'
...
FAVICONS = {
     ("icon", "/assets/css/images/favicon.ico", "16x16"),
...
TWITTER_CARD = {
    ...
    'site': '@ProyectoAconcag',  # twitter nick for the website
    # 'site:id': 123456,  # Same as site, but the website's Twitter user ID
                          # instead.
    'creator': '@ProyectoAconcag',  # Username for the content creator / author.
